    ...
    <div class="auth-inner my-2">
      ...
      <div class="card mb-0">
        <div class="card-body">
          ...
          <p class="card-text mb-2">Please sign in or create a new account</p>
          ...
          <form class="auth-login-form mt-2" action="{{route('login')}}" method="POST">
            ...
            <div class="mb-1">
              ...
              <input type="text" class="form-control" id="email" name="email" placeholder="Please Enter Your Email" aria-describedby="email" tabindex="1" autofocus="">
            </div>
