            ...
            class y extends l.default {
                ...
                _slide(t, e) {
                    const i = this._directionToOrder(t), s = a.default.findOne(v, this._element),
                        r = this._getItemIndex(s), l = e || this._getItemByOrder(i, s), c = this._getItemIndex(l),
                        d = Boolean(this._interval), u = i === h, f = u ? "carousel-item-start" : "carousel-item-end",
                ...
                createCarousel() {
                    const t = document.createElement("template"), e = this.sources.map(((t, e) => {
                            ...
                            let s = `<img src="${t}" class="d-block w-100 h-100 img-fluid" style="z-index: 1; object-fit: contain;" onload="${i}" />`,
                                n = "";
                            const o = this.getInstagramEmbed(t), r = this.getYoutubeId(t);
